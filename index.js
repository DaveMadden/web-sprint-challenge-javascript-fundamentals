...
/*This works because JS allows closures. If a function cannot find a variable in its own scope, it will keep looking progressively further outside its scope until it either finds what it's looking for and uses it or returns UNDEFINED. */
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(data){
    return data.map(x => x.animal_name.toLowerCase());
  }
  ...
  */
  ...
  function lowPopulationAnimals(data){
    return data.filter(x => x.population < 5);
  }
...
// const testerCube = CuboidMaker(2, 3, 4)
